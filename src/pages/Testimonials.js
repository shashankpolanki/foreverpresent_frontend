      ...
      <section className="py-20 bg-navy-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-semibold text-navy-900 mb-4">
            See ForeverPresent in Action
          </h2>
          <p className="text-navy-500 mb-8">
            Watch how families are using ForeverPresent to stay connected with their loved ones
          </p>

          <div className="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
            <div className="aspect-video bg-gradient-to-br from-navy-100 to-champagne-100 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-navy-600 font-medium">Video Coming Soon</p>
              </div>
            </div>
          </div>
        </div>
